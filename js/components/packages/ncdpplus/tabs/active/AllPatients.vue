...
import dataActivePatients from '@/data/ncdpplus/dataActivePatients';
...
const selectedComponent = (condition: string) => {
    return dataActivePatients.find(d => d.name == condition)
}
...
<template>
    <div class="space-y-6">
        <div class="bg-white p-6 rounded-xl shadow-sm border">
            <h2 class="text-lg font-semibold text-gray-800 mb-2">Condition Report <span class="text-lime-600">(Active Patients)</span></h2>
