...
import DiabetesQuarterChart from '@/components/charts/apexcharts/ncdpplus/Diabetes/Unspecified/QuarterChart.vue';
import FacilityDiabetesQuarterChart from "@/components/charts/apexcharts/ncdpplus/Diabetes/Unspecified/FacilityQuarterChart.vue";
    ...
    <Card class="border-0 shadow-sm">
        ...
        <CardContent class="pt-6 space-y-6">
            ...
            <div>
                ...
                <DiabetesQuarterChart :data="props.patientData" :description="props.description"
            ...
            <div>
                ...
                <FacilityDiabetesQuarterChart :data="props.patientData" :description="props.description"
                    class="border rounded-lg p-4 bg-gray-50" />
            </div>
            <!-- Table Section -->
            <div>
