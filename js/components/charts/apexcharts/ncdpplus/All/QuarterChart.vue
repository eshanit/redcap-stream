...
const processData = () => {
  ...
  props.data.forEach((item) => {
    const enrollmentDate = item.card_enrollment_date || item.dm_enrollment_date || 
                         ...
                         item.liver_enrollment_date || item.scd_enrollment_date || item.enroll_date_demo;
...
<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
      <div>
        <h3 class="text-lg font-semibold text-gray-800">Quarterly patient enrollment trends</h3>
