...
const chartData = computed<IChartData>(() => {
    ...
    for (const year in originalData) {
        ...
        if (yearNum <= 2014) {
            totalBefore2014 += originalData[year];
        } else {
    ...
    if (totalBefore2014 > 0) {
        aggregatedData['2014 and below'] = totalBefore2014;
    }

    // Create a new object to maintain order
    const orderedData: IChartData = { '2014 and below': totalBefore2014, ...aggregatedData };
