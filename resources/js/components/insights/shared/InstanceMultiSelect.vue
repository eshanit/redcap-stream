    ...
    <Card>
        ...
        <CardContent>
            ...
            <div class="" v-if="props.projectData?.length">
                ...
                <div class="py-5">
                    The table below shows counts for each selection/response and does not take into account multiple selects (combo-responses)
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full table-auto bg-white shadow-md rounded-lg">
                        ...
                        <tbody>
                            <tr v-for="(counts, instanceKey) in useInstanceSingleSelect(props.projectData).value"
                    ...
                    <div class="py-5" />
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Below is an analysis of respondents' analysis on multi-select answers.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div>
                                    This analysis is beyond the package you purchased, to access this analysis please contact the developer.
                                </div>
                            </CardContent>
                        </Card>
                </div>
