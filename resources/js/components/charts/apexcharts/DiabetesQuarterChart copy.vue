      ...
      <table class="min-w-full bg-white border border-gray-200">
        <thead>
          <tr class="bg-gray-200 text-gray-700">
            ...
            <th v-for="(category, index) in chartOptions.xaxis.categories" :key="index" class="py-3 px-4 text-left">{{
              category }}</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td v-for="(count, index) in series[0]?.data" :key="index" class="py-3 px-4 border-b border-gray-200">{{
              count }}</td>
          </tr>
        </tbody>
      </table>
