...
<template>
  <Head :title="`${project.app_title} - Epilepsy Patients`" />
    ...
    <div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-sm font-medium mb-4">
              Neurological Condition
            </div>
            
            <div class="flex items-center gap-4">
              <div class="w-16 h-16 bg-gradient-to-r from-purple-500 to-violet-500 rounded-2xl flex items-center justify-center text-3xl">
                🧠
              </div>
              <div>
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
                  Registered active Epilepsy patients aggregated per quarter and facility.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="w-10 h-10 bg-gradient-to-r from-purple-500 to-violet-500 rounded-xl flex items-center justify-center">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Epilepsy Patients</div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Epilepsy Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of active Epilepsy patients across facilities
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-gradient-to-r from-purple-500 to-violet-500 rounded-full"></span>
                <span class="text-sm text-slate-700 dark:text-slate-300">Epilepsy Patients</span>
              </div>
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
        ...
        <div class="bg-gradient-to-r from-purple-50 to-violet-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-purple-100 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            <div class="flex-shrink-0">
              <div class="w-16 h-16 bg-gradient-to-r from-purple-500 to-violet-500 rounded-2xl flex items-center justify-center">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">About Epilepsy</h3>
              <p class="text-slate-600 dark:text-slate-300 mb-4">
                Epilepsy is a neurological disorder marked by recurrent, unprovoked seizures. 
                This dashboard tracks active epilepsy patients who have had at least one clinical encounter 
                in the last 12 months, with data aggregated quarterly by facility.
              </p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Chronic neurological disorder</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Characterized by recurrent seizures</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Often managed with anticonvulsant medications</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Requires regular neurological follow-up</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border border-slate-200 dark:border-slate-700">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div 
              @click="router.get(`/packages/project/${project.project_id}/core_indicators/nppactivepatients/other_cardiac`)"
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Epilepsy Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
