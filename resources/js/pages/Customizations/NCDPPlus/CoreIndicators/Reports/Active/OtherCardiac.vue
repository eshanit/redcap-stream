...
import OtherCardiacPPlusChart from '@/components/charts/apexcharts/ncdpplus/Heart/OtherCardiac/PPlusChart.vue';
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Other/Unspecified Cardiac Condition',
    href: ''
  }
];
...
<template>
  <Head :title="`${project.app_title} - Other/Unspecified Cardiac Condition Patients`" />
    ...
    <div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-sm font-medium mb-4">
              Cardiac Condition
            </div>
            
            <div class="flex items-center gap-4">
              <div class="w-16 h-16 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl flex items-center justify-center text-3xl">
                ❤️
              </div>
              <div>
                <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white leading-tight">
                  Other/Unspecified Cardiac Condition
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
                  Registered active patients with other or unspecified cardiac conditions aggregated per quarter and facility.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Other Cardiac Patients</div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Other Cardiac Conditions Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of active patients with other or unspecified cardiac conditions
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full"></span>
                <span class="text-sm text-slate-700 dark:text-slate-300">Other Cardiac Conditions</span>
              </div>
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
          ...
          <OtherCardiacPPlusChart :active-patients-data="patients" />
        ...
        <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-orange-100 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            <div class="flex-shrink-0">
              <div class="w-16 h-16 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl flex items-center justify-center">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">About Other/Unspecified Cardiac Conditions</h3>
              <p class="text-slate-600 dark:text-slate-300 mb-4">
                This category includes patients with cardiac conditions that don't fit into specific diagnosed categories 
                or have unspecified cardiac diagnoses. This dashboard tracks active patients who have had at least one 
                clinical encounter in the last 12 months, with data aggregated quarterly by facility.
              </p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Includes unspecified cardiac conditions</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Covers rare or uncommon heart conditions</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">May include undifferentiated cardiac symptoms</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Requires ongoing cardiac monitoring and evaluation</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border border-slate-200 dark:border-slate-700">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div 
              @click="router.get(`/packages/project/${project.project_id}/core_indicators/nppactivepatients/heart_failure`)"
              class="group cursor-pointer bg-gradient-to-r from-red-50 to-pink-50 dark:from-slate-800 dark:to-slate-900 rounded-xl p-4 border border-red-100 dark:border-slate-600 transition-all duration-300 hover:scale-[1.02] hover:shadow-md"
            >
              <div class="flex items-center gap-3">
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Other/Unspecified Cardiac Condition Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
