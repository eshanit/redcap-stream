...
<template>
  <Head :title="`${project.app_title} - All Active Patients`" />
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
              Comprehensive overview of all active patients across all disease conditions aggregated per quarter and facility.
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                <div class="text-2xl font-bold text-slate-900 dark:text-white">Updated</div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Patient Distribution Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of active patients across all facilities
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-blue-500 rounded-full"></span>
                <span class="text-sm text-slate-700 dark:text-slate-300">Active Patients</span>
              </div>
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-blue-100 dark:border-slate-700">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Data Information</h3>
              <p class="text-slate-600 dark:text-slate-300">
                This chart shows the distribution of all active patients across different facilities for the current quarter. 
                Active patients are defined as those who have had at least one clinical encounter in the last 12 months. 
                Data is aggregated quarterly and updated in real-time as new patient visits are recorded.
              </p>
            </div>
            <div class="flex-shrink-0">
              <div class="bg-white dark:bg-slate-700 rounded-xl p-4 border border-slate-200 dark:border-slate-600">
                <div class="text-sm text-slate-500 dark:text-slate-400">Data Source</div>
                <div class="text-xl font-bold text-slate-900 dark:text-white">Redcap API</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • All Active Patients Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
