...
<template>
  <Head :title="`${project.app_title} - Congenital Heart Disease Patients`" />
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <div class="flex items-center gap-4">
              <div class="w-16 h-16 bg-gradient-to-r from-rose-500 to-pink-500 rounded-2xl flex items-center justify-center text-3xl">
                ❤️
              </div>
              <div>
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
                  Registered active Congenital Heart Disease patients aggregated per quarter and facility.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-gradient-to-r from-rose-500 to-pink-500 rounded-xl flex items-center justify-center">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Congenital Heart Disease Patients</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center">
                <svg class="w-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Congenital Heart Disease Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of active Congenital Heart Disease patients across facilities
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-gradient-to-r from-rose-500 to-pink-500 rounded-full"></span>
        ...
        <div class="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-rose-100 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            <div class="flex-shrink-0">
              <div class="w-16 h-16 bg-gradient-to-r from-rose-500 to-pink-500 rounded-2xl flex items-center justify-center">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">About Congenital Heart Disease</h3>
              <p class="text-slate-600 dark:text-slate-300 mb-4">
                Congenital Heart Disease (CHD) refers to structural heart defects present at birth. 
                This dashboard tracks active CHD patients who have had at least one clinical encounter 
                in the last 12 months, with data aggregated quarterly by facility.
              </p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Structural heart defects present at birth</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Range from simple to complex conditions</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Often detected during prenatal screening or infancy</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">May require surgical intervention and lifelong care</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Congenital Heart Disease Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
