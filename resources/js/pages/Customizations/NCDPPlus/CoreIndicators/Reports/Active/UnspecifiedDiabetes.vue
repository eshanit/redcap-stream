...
import ActiveUnspecifiedPatientsChart from '@/components/charts/apexcharts/ncdpplus/Diabetes/Unspecified/PPlusChart.vue';
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Unspecified/Gestational Diabetes',
    href: ''
  }
];
...
<template>
  <Head :title="`${project.app_title} - Unspecified/​Gestational Diabetes Patients`" />
    ...
    <div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 text-sm font-medium mb-4">
              Diabetes Condition
            </div>
            
            <div class="flex items-center gap-4">
              <div class="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center text-3xl">
                🤰
              </div>
              <div>
                <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white leading-tight">
                  Unspecified/Gestational Diabetes
                ...
                <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
                  Registered active Unspecified or Gestational Diabetes patients aggregated per quarter and facility.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Unspecified/Gestational Diabetes Patients</div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Unspecified/Gestational Diabetes Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of active Unspecified/Gestational Diabetes patients across facilities
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full"></span>
                <span class="text-sm text-slate-700 dark:text-slate-300">Unspecified/Gestational Diabetes</span>
              </div>
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
          ...
          <ActiveUnspecifiedPatientsChart :active-patients-data="patients" />
        ...
        <div class="bg-gradient-to-r from-pink-50 to-rose-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-pink-100 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">About Unspecified/Gestational Diabetes</h3>
              <p class="text-slate-600 dark:text-slate-300 mb-4">
                This category includes patients with unspecified diabetes types or gestational diabetes—a form 
                of high blood sugar affecting pregnant women. This dashboard tracks active patients who have had 
                at least one clinical encounter in the last 12 months, with data aggregated quarterly by facility.
              </p>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-pink-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Includes gestational diabetes during pregnancy</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-pink-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Covers unspecified diabetes diagnoses</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-pink-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">Requires specialized prenatal monitoring</span>
                </div>
                <div class="flex items-center gap-2">
                  <div class="w-2 h-2 bg-pink-500 rounded-full"></div>
                  <span class="text-sm text-slate-600 dark:text-slate-300">May resolve postpartum or require ongoing care</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border border-slate-200 dark:border-slate-700">
          <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-6">Related Diabetes Conditions</h3>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div 
              @click="router.get(`/packages/project/${project.project_id}/core_indicators/nppactivepatients/diabetes_1`)"
              class="group cursor-pointer bg-gradient-to-r from-green-50 to-emerald-50 dark:from-slate-800 dark:to-slate-900 rounded-xl p-4 border border-green-100 dark:border-slate-600 transition-all duration-300 hover:scale-[1.02] hover:shadow-md"
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <h4 class="font-semibold text-slate-900 dark:text-white group-hover:text-green-600 transition-colors">
                    Type 1 Diabetes
                  </h4>
            ...
            <div 
              @click="router.get(`/packages/project/${project.project_id}/core_indicators/nppactivepatients/diabetes_2`)"
              class="group cursor-pointer bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-slate-800 dark:to-slate-900 rounded-xl p-4 border border-emerald-100 dark:border-slate-600 transition-all duration-300 hover:scale-[1.02] hover:shadow-md"
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <h4 class="font-semibold text-slate-900 dark:text-white group-hover:text-emerald-600 transition-colors">
                    Type 2 Diabetes
                  </h4>
                  <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">View patient analytics</p>
                </div>
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Unspecified/Gestational Diabetes Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
