...
import LTFUUnspecifiedPatientsChart from '@/components/charts/apexcharts/ncdpplus/Diabetes/Unspecified/PPlusChart.vue';
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
      <Heading title="Mortality Patients Indicators"
        description="Registered Mortality Patients per disease/condition aggregated per quarter. Unspecified Diabetes"
        class="pt-5" />
      <LTFUUnspecifiedPatientsChart :active-patients-data="patients" />
    </div>
  </AppLayout>
</template>