...
import LTFUType2PatientsChart from '@/components/charts/apexcharts/ncdpplus/Diabetes/TypeII/PPlusChart.vue';
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
      <Heading title="Mortality Patients Indicators"
        description="Registered Mortality Patients per disease/condition aggregated per quarter. Type 2 Diabetes"
        class="pt-5" />
      <LTFUType2PatientsChart :active-patients-data="patients" />
    </div>
  </AppLayout>
</template>