...
<template>
  <Head :title="`${project.app_title} - Type 2 Diabetes LTFU Patients`" />
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white leading-tight">
              Type 2 Diabetes Lost To Follow Up Patients
            ...
            <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
              Comprehensive overview of Type 2 Diabetes LTFU patients aggregated per quarter and facility.
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Type 2 Diabetes LTFU</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                <div class="text-2xl font-bold text-slate-900 dark:text-white">Type 2</div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Type 2 Diabetes LTFU Patient Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of Type 2 Diabetes LTFU patients across all facilities
              </p>
            </div>
        ...
        <!-- Data Info Panel -->
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-green-100 dark:border-slate-700">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Type 2 Diabetes LTFU Information</h3>
              <p class="text-slate-600 dark:text-slate-300">
                This chart shows the distribution of Type 2 Diabetes patients lost to follow-up across different facilities for the current quarter. 
                Type 2 Diabetes is often associated with lifestyle factors and requires ongoing management through medication, diet, and exercise. 
                LTFU in this condition can lead to complications such as cardiovascular disease, neuropathy, and retinopathy. 
                Regular follow-up is crucial for preventing disease progression and managing comorbidities.
              </p>
            </div>
            <div class="flex-shrink-0">
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Type 2 Diabetes LTFU Patients Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
