...
<template>
  <Head :title="`${project.app_title} - Heart Failure Disease LTFU Patients`" />
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white leading-tight">
              Heart Failure Disease Lost To Follow Up Patients
            ...
            <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
              Comprehensive overview of Heart Failure Disease LTFU patients aggregated per quarter and facility.
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Heart Failure LTFU</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                <div class="text-2xl font-bold text-slate-900 dark:text-white">Heart Failure</div>
                <div class="text-sm text-slate-500 dark:text-slate-400">Cardiac Condition</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Heart Failure Disease LTFU Patient Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of Heart Failure Disease LTFU patients across all facilities
              </p>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                <span class="w-3 h-3 bg-amber-500 rounded-full"></span>
                <span class="text-sm text-slate-700 dark:text-slate-300">Heart Failure Disease</span>
              </div>
              <div class="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
        ...
        <div class="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-amber-100 dark:border-slate-700">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Heart Failure Disease LTFU Information</h3>
              <p class="text-slate-600 dark:text-slate-300">
                This chart shows the distribution of Heart Failure Disease patients lost to follow-up across different facilities for the current quarter. 
                Heart Failure is a chronic condition where the heart cannot pump blood effectively, requiring ongoing management and medication adjustments. 
                LTFU in heart failure patients can lead to worsening symptoms, frequent hospitalizations, reduced quality of life, and increased mortality. 
                Regular follow-up is essential for medication optimization, monitoring fluid status, and preventing acute decompensations.
              </p>
            </div>
            <div class="flex-shrink-0">
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Heart Failure Disease LTFU Patients Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
