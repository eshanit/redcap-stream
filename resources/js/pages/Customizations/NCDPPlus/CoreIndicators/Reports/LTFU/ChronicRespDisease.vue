...
<template>
  <Head :title="`${project.app_title} - Chronic Respiratory Disease LTFU Patients`" />
  
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="min-h-screen bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div class="max-w-7xl mx-auto">
        <!-- Header with Back Button -->
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div>
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 text-sm font-medium mb-4">
              Respiratory Condition
            </div>
            
            <h1 class="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white leading-tight">
              Chronic Respiratory Disease Lost To Follow Up Patients
            ...
            <p class="text-lg text-slate-600 dark:text-slate-300 mt-3 max-w-3xl">
              Comprehensive overview of Chronic Respiratory Disease LTFU patients aggregated per quarter and facility.
            </p>
          </div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="w-10 h-10 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-xl flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-xl flex items-center justify-center">
              ...
              <div>
                ...
                <div class="text-sm text-slate-500 dark:text-slate-400">Chronic Respiratory Disease LTFU</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex items-center gap-4">
              ...
              <div>
                <div class="text-2xl font-bold text-slate-900 dark:text-white">Respiratory</div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl border border-slate-200 dark:border-slate-700 mb-8">
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Chronic Respiratory Disease LTFU Patient Analysis</h2>
              <p class="text-slate-600 dark:text-slate-300 mt-1">
                Quarterly distribution of Chronic Respiratory Disease LTFU patients across all facilities
              </p>
            </div>
        ...
        <!-- Data Info Panel -->
        <div class="bg-gradient-to-r from-sky-50 to-cyan-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-lg border border-sky-100 dark:border-slate-700">
          <div class="flex flex-col lg:flex-row items-start lg:items-center gap-6">
            <div class="flex-shrink-0">
              <div class="w-16 h-16 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-2xl flex items-center justify-center">
            ...
            <div class="flex-grow">
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Chronic Respiratory Disease LTFU Information</h3>
              <p class="text-slate-600 dark:text-slate-300">
                This chart shows the distribution of Chronic Respiratory Disease patients lost to follow-up across different facilities for the current quarter. 
                Chronic Respiratory Diseases include conditions such as COPD, asthma, bronchiectasis, and interstitial lung diseases that affect lung function over time. 
                LTFU in these patients can lead to uncontrolled symptoms, acute exacerbations, decreased lung function, increased hospitalizations, and reduced quality of life. 
                Regular follow-up is essential for monitoring lung function, adjusting inhaler therapy, and managing comorbidities.
              </p>
            </div>
            <div class="flex-shrink-0">
        ...
        <div class="mt-8 text-center text-slate-500 dark:text-slate-400 text-sm">
          <p>© {{ new Date().getFullYear() }} Redcap Stream • Chronic Respiratory Disease LTFU Patients Dashboard • {{ project.app_title }}</p>
        </div>
      </div>
    </div>
  </AppLayout>
