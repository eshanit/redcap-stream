                        ...
                        <section class="mt-8">
                            ...
                            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                                <article v-for="s in visibleServices" :key="s.service"
                                    class="group flex cursor-pointer flex-col gap-3 border border-[#d9ded7] bg-[#fbfaf7] p-4 text-left transition hover:-translate-y-0.5 hover:border-[#9ab4a8] hover:bg-white"
