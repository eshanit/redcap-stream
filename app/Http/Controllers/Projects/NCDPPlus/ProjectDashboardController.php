...
namespace App\Http\Controllers\Projects\NCDPPlus;
...
class ProjectDashboardController extends Controller
{
    ...
    public function __invoke(int $projectId)
    {
        ...
        $healthFacilityCounts = $project->project_data()
            ->where('field_name', 'facility_demo')
            ->groupBy('value')
            ->select('value', DB::raw('count(*) as count'))
            ->pluck('count', 'value');
        ...
        return Inertia::render('Projects/NCDPPlus/Index', [
