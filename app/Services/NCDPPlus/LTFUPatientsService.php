...
class LTFUPatientsService
{
    ...
    /**
     * Get LTFU patients data for a specific disease type
     */
    public function getLTFUPatients(
    ...
    /**
     * Get summary statistics for LTFU patients
     */
    public function getLTFUPatientsSummary(
        string $diagnosisField,
        string $outcomeField,
        array $diagnosisValues,
        array $visitFields
    ): array {
        $patients = $this->getLTFUPatients($diagnosisField, $outcomeField, $diagnosisValues, $visitFields);
